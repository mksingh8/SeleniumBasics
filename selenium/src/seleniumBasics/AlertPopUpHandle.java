...
public class AlertPopUpHandle {
	...
	public static void main(String[] args) throws Exception {
		...
		Alert alert = driver.switchTo().alert();// this will return a Alert, just store the result in Alert datatype
												// variable
		...
		// window popup might appear when user clicks on the browse button to find the
		// file to be uploaded. Windows pop
		...
		/*
		 * Browse the file to be uploaded using the send keys command. identify the
		 * webelement to upload the file, but don't use the click command, as window app
		 * pop will appear and selenium would not be able to handle it.
		 */
		driver.findElement(By.xpath("//input[@name='fileupload']"))
				.sendKeys("/home/manish/Downloads/MySql/MySql Guide");
	}
